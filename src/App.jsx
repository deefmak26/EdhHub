  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans p-5" dir="rtl">
      ...
      <header className="flex justify-between items-center mb-8">
        <button className="bg-blue-600 px-4 py-2 rounded-xl flex items-center gap-2 text-sm font-bold">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-slate-400 text-sm mb-8 leading-relaxed px-4">منصة شاملة للملفات الطبية والمحاضرات التفاعلية</p>
        
        <div className="relative max-w-md mx-auto">
          <input 
            type="text" 
            placeholder="ابحث عن محاضرات، كتب، أو مراجع..." 
            className="w-full bg-[#111827] border border-slate-800 p-4 rounded-2xl text-right text-xs outline-none focus:border-blue-500/50 transition-all"
          />
      ...
      <div className="grid grid-cols-2 gap-4">
        {categories.map((cat, i) => (
          <div key={i} className="bg-[#0f172a] p-8 rounded-[2.5rem] border border-slate-800/60 text-center flex flex-col items-center justify-center shadow-2xl">
            <div className="bg-[#1e293b] p-5 rounded-2xl mb-6 text-slate-200">
              {cat.icon}
            </div>
